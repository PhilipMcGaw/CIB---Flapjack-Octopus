...
[![KiCAD](https://badgen.net/badge/icon/KiCAD?icon=kicad&label)](https://kicad.org/)
<!-- removed as not used in this repo ![Fusion 360](https://badgen.net/badge/icon/FUSION%20360?icon=autodesk&label) -->
...
This is a breakout PCB for a Labjack T7, with 2.5 mm pitch screw headers to allow for quick wiring to the breakout PCB.
  ...
  * Analogue in ports are taken via a potential divider to allow pre-scaling if required.
